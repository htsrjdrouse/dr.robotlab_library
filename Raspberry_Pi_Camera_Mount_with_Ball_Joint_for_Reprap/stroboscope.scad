...
module stroboscope_miuzei_back(){
difference(){union(){
translate([0,0,-2.6])difference(){cube([63-30+4,33+1.5-l,5]);translate([7,0,-0.5])cube([20,10+3,6]);}
//translate([0,0,-6.65])cube([63-40,33,6.65]);
//translate([0,0,-6.65])basesupport_a();
//translate([65,-40,0])cube([63-40,33,6.65]);

translate([2.5-2.5,-9+5,0-2.6])color("pink")cube([42+15,9-4,26+5.5]);
...
color("lightblue")translate([14.5,33-4.2-0.5-l,-1.5])rotate([0,0,14.5])cube([9.2+11,2,16.5+4]);


//translate([0,1.5,9-3.5])#cube([63,8,3.6]);
//translate([18.6,18.2,-3])#cylinder(r=10/2,h=20);
translate([18.6,18.2-25,-3+5-1.5])rotate([0,90,90])cylinder(r=3.7/2,h=20);
translate([18.6,18.2-25,-3+5-1.5+25])rotate([0,90,90])cylinder(r=3.7/2,h=20);
/*
translate([18.6-13,18.2+6+3,-3])cylinder(r=4/2,h=20);
translate([18.6-13,18.2+6-20,-3])cylinder(r=4/2,h=20);
//translate([18.6-13+13,18.2+6+3,-3])cylinder(r=4/2,h=20);
...
*/
translate([18.6,18.2-10,12.5])rotate([90,0,0])#cylinder(r=18/2,h=20);
translate([33.5+5-3,-10.5+5,12.5-3])rotate([-90,90,0])#cylinder(r=1.3/2,h=20);
translate([33.5+5-3,-10.5+5,12.5+3])rotate([-90,90,0])#cylinder(r=1.3/2,h=20);
translate([33.5+5-3+5,-10.5+5,12.5-3])rotate([-90,90,0])#cylinder(r=1.3/2,h=20);
translate([33.5+5-3+5,-10.5+5,12.5+3])rotate([-90,90,0])#cylinder(r=1.3/2,h=20);
translate([33.5+5-3+10,-10.5+5,12.5-3])rotate([-90,90,0])#cylinder(r=1.3/2,h=20);
translate([33.5+5-3+10,-10.5+5,12.5+3])rotate([-90,90,0])#cylinder(r=1.3/2,h=20);


translate([33.5+5-3-4,-10.5+5,12.5-12.5])rotate([-90,90,0])#cylinder(r=3.7/2,h=40);
translate([33.5+5-3-4-28,-10.5+5,12.5-12.5])rotate([-90,90,0])#cylinder(r=3.7/2,h=40);
//translate([33.5+5-3,-10.5+5,12.5])led();
translate([0,0,0]){
//translate([25.5-2,-0.5+2,10.0])rotate([0,0,-15])#cube([11.5-2,2+4,5]);
//translate([25.5+11.5/2,-0.5-3-8,10.0])cube([11.5/2,5+9,5]);
}
translate([33.5-15.0,-10.5+5,12.5])rotate([90,0,0])#cylinder(r=16/2,h=4);
}
...
module stroboscope_miuzei_mirror(l=10){
difference(){union(){
/*
translate([33.5+5-3,-10.5+3,12.5]){
translate([0,0,0])rotate([-90,0,23.65]){
for(i=[0:10]){
translate([-0,0+i,6.65])#cylinder(r=10/2,h=5.5);
}
}
}
*/
...
color("lightblue")translate([14.5,33-4.2-0.5-l,-1.5+3.5])rotate([0,0,14.5])cube([9.2+11+3,2,16.5+4]);
//translate([0,1.5,9-3.5])#cube([63,8,3.6]);
//translate([18.6,18.2,-3])#cylinder(r=10/2,h=20);
translate([18.6,18.2-25,-3+5-1.5])rotate([0,90,90])cylinder(r=3.7/2,h=20);
translate([18.6,18.2-25,-3+5-1.5+25])rotate([0,90,90])cylinder(r=3.7/2,h=20);
...
*/
translate([18.6,18.2-10,12.5])rotate([90,0,0])cylinder(r=14.5/2,h=20);
translate([33.5+5-3,-10.5+5,12.5-3])rotate([-90,90,0])#cylinder(r=2/2,h=20);
translate([33.5+5-3,-10.5+5,12.5+3])rotate([-90,90,0])#cylinder(r=2/2,h=20);

translate([33.5+5-3-4,-10.5+5,12.5-12.5])rotate([-90,90,0])#cylinder(r=2.8/2,h=40);
translate([33.5+5-3-4-28,-10.5+5,12.5-12.5])rotate([-90,90,0])#cylinder(r=2.8/2,h=40);
//translate([33.5+5-3,-10.5+5,12.5])led();
translate([0,0,0]){
//translate([25.5-2,-0.5+2,10.0])rotate([0,0,-15])#cube([11.5-2,2+4,5]);
//translate([25.5+11.5/2,-0.5-3-8,10.0])cube([11.5/2,5+9,5]);
...
translate([0,0,0])rotate([-90,0,23.65+3]){
difference(){
//#sphere(r=9.9/2);
union(){
translate([-0,0,4])cylinder(r=6.5/2,h=13);
translate([-0,0,4-4])#cylinder(r=4.5/2,h=13);
}
//#cylinder(r=4.5/2,h=23);
}
