...
translate([13.15/2+0.5,12.7+2.8,-24])cylinder(r=15.4/2,h=50);
}
}
}
}
...
/*
module sensl_microFC-SMA-60035(){
...
translate([18.6-13,18.2+6+3,-13])cylinder(r=4/2,h=15);
translate([18.6-13+13,18.2+6+3,-13])cylinder(r=4/2,h=15);
translate([18.6-13,18.2+6-20,-13])cylinder(r=4/2,h=15);
translate([18.6-13+13,18.2+6-20,-13])cylinder(r=4/2,h=15);
}
}
*/
...
for (a =[0:60]){
translate([33.5-15.0,-10.5+5-15-(0.5*a),12.5-20])rotate([0,0,0])#cylinder(r=4/2,h=2.5);
}
...
translate([0,1.5,9-3.5])cube([63,8,3.5]);
