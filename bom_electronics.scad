...
/*
for(i=[-4:4]){translate([i*12.5,0,0])
difference(){
cylinder(r=12/2,h=5);
...
difference(){
translate([-5,0,0])cube([61.9+10,39.3,5]);
...
translate([15.186,20.875,-50.1])rotate([0,0,45])#cylinder(r=10/2,h=200);
translate([15.186,20.875,-50.1])rotate([0,0,45])#cylinder(r=27/2,h=55.25-2,$fn=4);
translate([15.186+18,20.875,-50.1])rotate([0,0,45])#cylinder(r=27/2,h=55.25-2,$fn=4);
translate([15.186+36,20.875,-50.1])rotate([0,0,45])#cylinder(r=27/2,h=55.25-2,$fn=4);
