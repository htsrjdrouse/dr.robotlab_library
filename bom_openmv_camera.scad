...
for(i=[0:9]){
 translate([-3.1-80,-11.725-15+5+5,-17.5+2-36+3+i*9 ])rotate([90,0,90]){translate([0,0,82.06])cylinder(r=8/2,h=3.5);cylinder(r=3.7/2,h=500);}
...
translate([-3-4-15+5+5,0-25+5.7,35.5-10+6+27])rotate([0,90,0])cylinder(r=7.7/2,h=10);
