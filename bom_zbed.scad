...
//start zbed_smz_components
 translate([75,30,4])microwell_plate_guide();
 ...
 translate([-170+106+90,-30+55+30,-1])rotate([0,0,90])bed_leveler_better();
 translate([-170+106+90,-30+55,-1])rotate([0,0,90])bed_leveler_better();
 //translate([-170,-60,-1])import("bed_leveler_foot.STL");
 //translate([-170,-30,-1])import("bed_leveler_foot.STL");
 translate([-170+106,-30+55,-1])rotate([0,0,90])bed_leveler_better();
 translate([-170+106,-30+55+30,-1])rotate([0,0,90])bed_leveler_better();
