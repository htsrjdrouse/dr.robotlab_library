...
moving_zbed_parts_higher();
translate([-80,315-122,172-156])rotate([0,0,0])tslot20(437);
translate([-80+611,315-122,172-156])rotate([0,0,0])tslot20(437);
translate([480,0,0])mirror([1,0,0])moving_zbed_parts_higher();
translate([0,0,z]){
