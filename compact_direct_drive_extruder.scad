...
{
	//htsrmodinlet
        translate([0,21.1,0])#htsr_mod_inlet();
...
module htsr_mod_inlet(){
difference(){
union(){
translate([-5,0,0])cube([18,10,20]);
translate([-5,-52,0])cube([18,10,20]);
}
translate([4,80,12])rotate([90,0,0])cylinder(r=5/2,h=400);
translate([4,80,12])rotate([90,0,0])cylinder(r=9.4/2,h=78);
translate([4,-52+8,12])rotate([90,0,0])cylinder(r=9.4/2,h=78);
}
}
