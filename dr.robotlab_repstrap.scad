...
module motormount_smaller_igus_slidermount_vertical_adjust_nema17(){
 mmx = 42;
 mmy = 42;
 mmz = 8.5+1.5;
 mmposx = 0;
...
difference(){
union(){
translate([20,27,0])cylinder(r=(18-2)/2,h=17);
translate([20,27,0])cylinder(r=28/2,h=4);
translate([20,27-2,0])cylinder(r=28/2,h=4);
translate([20,27+2,0])cylinder(r=28/2,h=4);
/*
translate([20,10-1,0])cylinder(r=14/2,h=4);
translate([20,45,0])cylinder(r=14/2,h=4);
...
translate([-50,27.2,7.5])rotate([90,0,90])cylinder(r=3/2,h=80);
translate([20-2,10-1+6.27,0-100])cylinder(r=4.7/2,h=180);
translate([20-2,10-1+6.27,4])cylinder(r=10.2/2,h=180);
translate([20,10-1,4.1])cylinder(r=8.9/2,h=38);
translate([20-2,45-6.5,0-100])cylinder(r=4.7/2,h=180);
translate([20-2,45-6.5,4])cylinder(r=10.2/2,h=180);
translate([20,45,4.1])cylinder(r=8.9/2,h=38);
//translate([20,27,1+5])cylinder(r=22.4/2,h=7);
translate([20,27,-0.1])cylinder(r=8.1/2,h=50);
translate([20+7,27+10,12])rotate([90,0,0])cylinder(r=3/2,h=25);
...
translate([-38.25+14-13.9+20-20,-70+30.-5-5,22.5+3.8-1.0])cube([44.5-20+20-23,5+10+5,thick]);
translate([-38.25+14-13.9+20-20-4,-70+30.-5-5-4,22.5+3.8-1.0])cube([44.5-20+20-23,5+10+5+4,thick+5]);
}
translate([-90,-40,29])rotate([0,90,0])cylinder(r=3.6/2,h=73);
}
for(i=[0:0]){
...
translate([0,-20-9,0])difference(){
translate([-38.25+14-13.9+20,-70+30.-5,22.5+3.8-1.0])cube([44.5-20,11+5,thick]);
for(i=[0:0]){
translate([-38.25+14-13.9+13.7+11.9-i,-70+34,22.5+3.8-50])cylinder(r=3.7/2,h=120);
translate([-38.25+14-13.9+13.7+13+11.9-i,-70+34,22.5+3.8-50])cylinder(r=3.7/2,h=120);
}
...
translate([-38.25+14-13.9,-70+30-5,22.5])rotate([-90,0,0])cylinder(r=24/2,h=10);
...
translate([-38.25+14-13.9,-70+30-10+8+5-10,22.5+8])rotate([-90,0,0])cylinder(r=8.5/2,h=4,$fn=35);
translate([-38.25+14-13.9-8,-70+30-10+8+5-10,22.5])rotate([-90,0,0])cylinder(r=8.5/2,h=4,$fn=35);
translate([-38.25+14-13.9+8,-70+30-10+8+5-10,22.5])rotate([-90,0,0])cylinder(r=8.5/2,h=4,$fn=35);
...
module smaller_igus_slidermount_vertical_adjust_nema17(){
translate([-30,-98+1.5,-2])rotate([90,-90,0])motormount_smaller_igus_slidermount_vertical_adjust_nema17();
//guide TS-04-09-50
//carriage TW-04-09

translate([2,-30,0])
translate([-45,-33-10,-6])
translate([5,-40+20+10+77,0])import("TS_04_09_105_2.stl");
...
bg=0.4;color([bg,bg,bg])
//color("pink")
translate([0-7.5,-40+20+10+3,0])cube([25,101,4]);
//translate([0-7.5+10,-40+20+10+3+15,0])cube([5,105,8]);
translate([0-7.5-10-32,-40+20+10+3-8,0])cube([10+15+10+10+32,15+8,6+3-5]);
...
translate([5,-40+20+10+3-8+20,17])rotate([90,0,0])cylinder(r=9/2,h=30);
translate([5,-40+20+10+3-8+20+60,17])rotate([90,0,0])cylinder(r=2/2,h=60);
//translate([5+20,20+(-5.5*10)-1.5,0]){cylinder(r=3.7/2,h=40);translate([0,0,5+11])cylinder(r=6.7/2,h=3.5);}//cylinder(r=5.4/2,h=3+4,$fn=6);}
translate([0,-33,0])for(a=[4,6,8,10]){
translate([5,20+(a*10),-5]){cylinder(r=1.5/2,h=40);}//translate([0,0,5-4.5])cylinder(r=5.4/2,h=3+4,$fn=6);}
}
//translate([15,-27+(0*10),0]){cylinder(r=3.7/2,h=100);translate([0,0,2.6])cylinder(r=6.7/2,h=3.5+12);}
translate([5,-36+(0*10),0]){cylinder(r=3.7/2,h=10);translate([0,0,2.6])cylinder(r=6.7/2,h=6.5);}
//for(a=[0,4]){
...
module smallsyringe_valvesupportmodule_plate_decap(){
translate([45,15.5,0])difference(){
union(){
translate([0,0,-70])difference(){union(){
translate([-20-1.6+0.9,-32.5+5+17.5+14,83])cube([5,20+15-15,53+7]);
translate([-20-1.6+0.9,-32.5+5+17.5+20,83+5])cube([5,20+15,15]);
//translate([-20-1.6+0.9,-32.5+5+17.5,83+5+39+8.5])cube([5,20,22]);
translate([-20-1.6+0.9,-32.5+5+17.5+20,83+5+39+15.5])cube([5,20+15,15]);}
...
for(i=[0:4]){
translate([-30,0+16-7,90+10-10+i*11])rotate([90,0,90]){cylinder(r=3/2,h=20);}
}
...
translate([-30,0+16,90+10])rotate([90,0,90]){cylinder(r=3/2,h=20);}//translate([0,0,13])cylinder(r=6.8/2,h=3,$fn=6);}
translate([-30,0+16,90+40])rotate([90,0,90]){cylinder(r=3/2,h=20);}//translate([0,0,13])cylinder(r=6.8/2,h=3,$fn=6);}
translate([-30,0,90+12])rotate([90,0,90])cylinder(r=5.6/2,h=20);
translate([-30,0,90+38])rotate([90,0,90])cylinder(r=5.6/2,h=20);
translate([-30,0+20-5+15,96.9+1.7])rotate([90,0,90]){cylinder(r=3/2,h=20);}//translate([0,0,13])cylinder(r=6.8/2,h=3,$fn=6);}
translate([-30,0+20+5+15,96.9+1.7])rotate([90,0,90]){cylinder(r=3/2,h=20);}//translate([0,0,13])cylinder(r=6.8/2,h=3,$fn=6);}
translate([-30,0+20-5+15,147.7-0.5])rotate([90,0,90]){cylinder(r=3/2,h=20);}//translate([0,0,13])cylinder(r=6.8/2,h=3,$fn=6);}
...
difference(){
union(){
translate([0,0,-2-1.4-1.5+1.2-2+2+1])cylinder(r=15,h=10.7/2);
translate([0,0,-2-1.4-1.5+1.2-2+2+1])cylinder(r=13,h=8);
translate([0,0,-2-1.4-1.5+1.2-2+2+1])cylinder(r=8,h=15);
}
translate([-30,0,9])rotate([0,90,0])#cylinder(r=2.2/2,h=59);
translate([0,0,9])rotate([-90,0,0])#cylinder(r=2.2/2,h=59);

translate([0,0,-17])cylinder(r=9.5/2,h=16);
//translate([0,0,8-2.5])#cylinder(r=9.5/2,h=18);
/*
translate([-2.5/2,-6.8,8-2.5])cube([2.5,9.5+4.8,3.4]);
translate([6.8,-2.5/2,8-2.5])rotate([0,0,90])cube([2.5,9.5+4.8,3.4]);
...
rotate([0,0,-5]){
translate([0,0,-5])rotate([0,0,40])
translate([16.3/2,0,-2])cylinder(r=2.3/2,h=10);
translate([0,0,-5])rotate([0,0,40])
translate([-16.3/2,0,-2])cylinder(r=2.3/2,h=10);
}
rotate([0,0,0]){
translate([0,0,-5])rotate([0,0,40])translate([0,14/2,-2])cylinder(r=2.3/2,h=10);
translate([0,0,-5])rotate([0,0,40])translate([0,-14/2,-2])cylinder(r=2.3/2,h=10);
}
rotate([0,0,-30]){
translate([0,0,-5])rotate([0,0,40])translate([0,22/2,-2])cylinder(r=2.3/2,h=10);
translate([0,0,-5])rotate([0,0,40])translate([0,-22/2,-2])cylinder(r=2.3/2,h=10);
}
rotate([0,0,-65]){
translate([0,0,-5])rotate([0,0,40])translate([0,16/2,-2])cylinder(r=2.3/2,h=10);
translate([0,0,-5])rotate([0,0,40])translate([0,-16/2,-2])cylinder(r=2.3/2,h=10);
}
}
//#cylinder(r=5.1/2,h=8);
...
module valvemountplate_screwattach_smallersyringe_valve_pp(){
translate([41,12,0]){
translate([33+10,28,34])rotate([-90,180,90])mirror([0,0,0])union(){
difference(){union(){
translate([-3+19,18+0.1+2.5,12])cube([19.5,16,7+6]);
...
module valvemountplate_screwattach_smallersyringe_vertical_attach_pinchvalve(){
translate([41,12,0]){
translate([33+10,28,34])rotate([-90,180,90])mirror([0,0,0])difference(){union(){
translate([-3+19+5,18+0.1+2.5-4,12+13+18.85])cube([19.5-5,16+4,7+6+38.5-13-20]);
...
translate([30-5.5+5.8,10+1.5+10.27,40-70])cylinder(r=2.8/2,h=150);
translate([30-5.5+5.8,10+1.5+10.27+10,40-70])cylinder(r=2.8/2,h=150);
...
difference(){
union(){
translate([0,0,-2-1.4-1.5+1.2-2+2+1])cylinder(r=13,h=7+16.4,$fn=20);
}
translate([0,0,-2-1.4-1.5+1.2-2+2+1])#cylinder(r=8.24,h=7,$fn=20);
...
translate([23.3,0,-2-1.4-1.5+1.2-2+2+1])rotate([0,0,45])cylinder(r=10,h=10+1.4+1.5-1.2+2-2-1,$fn=4);
translate([23.3,0+5.5,-2-1.4-1.5+1.2-2+2+1])rotate([0,0,45])cylinder(r=10,h=10+1.4+1.5-1.2+2-2-1,$fn=4);
}

translate([-5.16+5.5+25,-50-3.08+134-66.5+3.8-10.5,61.68-128.5+71.5-50])rotate([0,0,0])#cylinder(r=3.7/2,h=100,$fn=30);
translate([-5.16+5.5+25,-50-3.08+134-66.5+3.8-20.5,61.68-128.5+71.5-50])rotate([0,0,0])#cylinder(r=3.7/2,h=100,$fn=30);

translate([0,0,-2-1.4-1.5+1.2-2+2+1-1])cylinder(r=15+0.3,h=10+1.4+1.5-1.2+2-2-1+5);
#translate([-5.16+3-0.6,-50-3.08+134-66.1,61.68-128.5+71.5])rotate([0,90,0])cube([4,6.6,5.4+1.2]);
translate([-5.16+5.5,-50-3.08+134-66.5+3.8,61.68-128.5+71.5-50])rotate([0,0,0])#cylinder(r=3.6/2,h=100,$fn=30);
...
color("")translate([52,190,63])rotate([-90,90,0])smallsyringe_valvesupportmodule_plate_microservo();
...
module syringe30mlshuttle_clipbracket(){
translate([46.25,-57,300-4])rotate([180,0,90])difference(){
union(){
translate([64.7-5,14.4-3-3,155.75-10+10])cube([25,15+3+3,10+11+10-3-10]);
difference(){
union(){
translate([64.7-5+12.5+0.2,14.4-3-3+10.5+2.5,155.75+18])cylinder(r1=(24.5+1)/2,r2=(24.5+1)/2,h=3);
translate([64.7-5+12.5+0.2,14.4-3-3+10.5,155.75+18])cylinder(r1=(24.5+1)/2,r2=(24.5+1)/2,h=3);
}
translate([64.7-5,14.4-3-3+21,155.75-10+15])cube([25,15+3+3,10+11+10-3]);
}
//translate([64.7-5,14.4-3-3,155.75-10])cube([25,15+3+3,10+11+10+3]);
translate([64.7+7.5,14.4+7.5-3,155.75+20-1.5-4-20+10])cylinder(r=14/2,h=24-10);
}
translate([64.7+7.5-9-5,14.4+7.5-3-25.5,155.75+20-1.5-4])cube([28,15,11.5]);
translate([64.7+7.5,14.4+7.5-3+3.5,155.75+20-1.5-4])cylinder(r1=15.5/2,r2=13.5/2,h=10.7);
translate([64.7+7.5,14.4+7.5-3+3.5,155.75+20-1.5-4])cylinder(r=(11.5+7.74)/2,h=10.7);
translate([64.7+7.5,14.4+7.5-3+3.5,155.75+20-1.5-4])cylinder(r=(19+7.74)/2,h=1.6);
translate([64.7+7.5-9-5,14.4+7.5-3-3,155.75+20-1.5-4])cube([28,15,1.5+0.1]);
translate([64.7+7.5,14.4+7.5-3+3.5,155.75+20-1.7-4])cylinder(r=(14+2)/2,h=24);
//translate([65.2+0.75,14.4+7.5,155.75+20-1.5-4])cube([14-1.5,14,24]);




//translate([64.7-5,14.4-3-0.87,155.75])translate([17.25,5.8,-10])translate([0,0,-100])cylinder(r=2.8/2, h=200);
translate([64.7-5,14.4-3-0.87,155.75])translate([17.25,5.8,-10])translate([0,0,-100])cylinder(r=2.8/2, h=200);
//translate([64.7-5,14.4-3-0.87,155.75])translate([17.25,5.8,-10])translate([0,0,4])cylinder(r=6.9/2, h=3.2, $fn=6);
//translate([64.7-5,14.4-3-0.87,155.75])translate([17.25,5.8,-10])translate([0,0,4])translate([0,-3.5,0])cube([12,7,3.2]);
//translate([64.7-5,14.4-3-0.87,155.75])translate([17.25,5.8,-10])translate([-9,0,4])cylinder(r=6.9/2, h=3.2, $fn=6);
//translate([64.7-5,14.4-3-0.87,155.75])translate([17.25,5.8,-10])translate([-9,0,4])translate([-12,-3.5,0])cube([12,7,3.2]);
translate([64.7-5,14.4-3-0.87,155.75])translate([17.25,5.8,-10])translate([-9,0,-100])cylinder(r=2.8/2, h=200);
}
}
...
module igus_TW_04_12_slider(){
 translate([0,-60-7+12,6.85])
 //color("darkgrey")
 import("igus_sliders/TW_04_12_1.stl");
 color("darkgrey")
 import("igus_sliders/TS_04_12_150_2.stl");
}
...
translate([2,10+(a*25),-5]){#cylinder(r=2.7/2,h=40);}//translate([0,0,4])cylinder(r=6.8/2,h=3+4,$fn=6);}
}
translate([17.5,-33,0])for(a=[0,4,8,12]){
...
module syringe30mlmount_plungerfix(){
difference()translate([0,0,50]){union(){
translate([3.5+2.5,0,0])difference(){union(){
translate([30,19,161-50])rotate([90,90,-90]){
translate([0,0-5,-4-3])cube([15,38+10,23-2+3+4+3]);
translate([-5,0-7.15/2,-4])cube([5,38+7.15,24+4]);
}
}
translate([30,19,161-50])rotate([90,90,-90])translate([6,2-5.25,0-5-5])cube([2.7,34+10.5,20+5+4.55+5]);
translate([30,19,161-50])rotate([90,90,-90])translate([-14+1+25-4,19,11.4+3-1-7.15/2])rotate([90,0,90])cylinder(r=26/2,h=300);
translate([30,19,161-50])rotate([90,90,-90])translate([-14+1,19,11.4-7.15/2])rotate([90,0,90])cylinder(r=24.8/2,h=300);
translate([30+5,19+4,161-50])rotate([90,90,-90])translate([-24,11.5-1,-5])cube([30,17+8,17+5]);
//translate([30,19,161-50])rotate([90,90,-90])translate([-20-1.6+0.9+20.7+9,-32.5+5+28-0.5-0.4+19.75,-20+115-66])rotate([0,90,0])cylinder(r=29/2,h=7);

//translate([-20-1.6+0.9+20.7+1-3.5-2.5,-32.5+5+28-0.5-0.4,-20+115+4-4])cylinder(r=24.5/2,h=7.5+4);
}
}
}
}
...
translate([30,19,161-50])rotate([90,90,-90])translate([6,2,0-5])cube([2.7,34,20+5]);
translate([30,19,161-50])rotate([90,90,-90])translate([-14+1+25-4,19,11.4+3-1])rotate([90,0,90])cylinder(r=26/2,h=300);
translate([30,19,161-50])rotate([90,90,-90])
translate([-14+1,19,11.4])rotate([90,0,90])cylinder(r=17.25/2,h=300);
translate([30,19,161-50])rotate([90,90,-90])
translate([-24,11.5-1,-5])cube([30,17,17]);
...
union(){
cylinder(r=15,h=15);
translate([-1,0,0])cylinder(r=15,h=15);
}
/*
translate([-16,0,-32]){
//translate([0+18.5+4-22,-24+7,39])rotate([90,0,90])cylinder(r=7.75/2,h=25,$fn=6);
...
translate([18.5+6-3.55,0,0])cylinder(r=10/2,h=200);
translate([0+18.5+6-3.55,0,0])difference(){union(){
translate([0,0,33])cylinder(h = 2.5, d1 = 10, d2 = 24.5, center = false);translate([0,0,32+3])cylinder(r=16.5/2,h=25);}cylinder(r=9.5/2,h=200);}
}
}
...
module syringe30mlmount_plungerfix_assy(){
translate([-41,-170,10.5])rotate([0,-90,-90])syringe30mlmount_plungerfix();
translate([-60,-81.5+1.5+56,20.4])difference(){
union(){
translate([-5,0,0])cube([53+4,20,3.5]);
translate([53-18,-8-7,0])cube([18,35+14,5]);
}
translate([43.5,-1-6,-6])
translate([0,0,0])cylinder(r=5.7/2,h=10.1);
translate([43.5,-1-6,-6])
translate([0,0,10])cylinder(r=9.7/2,h=3);

translate([43.5,20+6,-6])
cylinder(r=5.7/2,h=10.1);
translate([43.5,20+6,-6])
translate([0,0,10])cylinder(r=9.7/2,h=3);
}
...
module iverntech_pump_slider_plate_connect(){ 
translate([0,0,1])difference(){
union(){
translate([-110+55.5,-81.5+1.5+40+6.6+3.5-14.5,16+15])cube([22+5,6.5,35-15]);
}
...
module iverntech_pump_slider_plate_directdrive(){ 
translate([0,0,1])difference(){
union(){
translate([-110+55.5+3+3.3+1,-81.5+1.5+40-24+10,16])cube([22+5-3.5-4,11,7+5.8]);
//translate([-110+55.5+3,-81.5+1.5+40-25,16])cube([22+5-3.5,28.5,7]);
translate([-110+55.5,-81.5+1.5+40,16])cube([22+5,28.5,7]);
translate([-110+55.5,-81.5+1.5+40+6.6+3.5-14.5,16])cube([22+5,6.5,35]);
//translate([-110+55.5,-81.5+1.5+40+6.6+3.5,16])cube([22+5,6.5,30]);
}
translate([-110+59+5.3-1.6+3,-81.5+1.5+20+11,36-3.4-17])rotate([0,0,0]){#cylinder(r=2.8/2,h=20);}//cylinder(r=6.8/2,h=9,$fn=6);}
translate([-110+59+5.3-1.6+13,-81.5+1.5+20+11,36-3.4-17])rotate([0,0,0]){#cylinder(r=2.8/2,h=20);} //cylinder(r=6.8/2,h=9,$fn=6);}
//translate([-110+59+5.3,-81.5+1.5+146,36-3.4])rotate([90,90,0])cylinder(r=3.7/2,h=200);
#translate([-110+59+5.3+4.5-1,-81.5+1.5+146,36-3.4+10.25+2])rotate([90,90,0])cylinder(r=3.7/2,h=200);
#translate([-110+59+5.3+4.5-1-4.5,-81.5+1.5+146,36-3.4+10.25+2-6])rotate([90,90,0])cylinder(r=3.7/2,h=200);
...
module iverntech_pump_slider_plate_directdrive_plexium(){ 
translate([0,0,1])difference(){
union(){
translate([-110+55.5+3+3.3+1,-81.5+1.5+40-24+10,16])cube([22+5-3.5-4,11,7+5.8]);
//translate([-110+55.5+3,-81.5+1.5+40-25,16])cube([22+5-3.5,28.5,7]);
translate([-110+55.5,-81.5+1.5+40,16])cube([22+5,28.5,7]);
translate([-110+55.5,-81.5+1.5+40+6.6+3.5-14.5,16])cube([22+5,6.5,38]);
//translate([-110+55.5,-81.5+1.5+40+6.6+3.5,16])cube([22+5,6.5,30]);
}
#translate([-110+59+5.3+4.5-1,-81.5+1.5+146,36-3.4+10.25+2])rotate([90,90,0])cylinder(r=3.7/2,h=200);
#translate([-110+59+5.3+4.5-1-4.5,-81.5+1.5+146,36-3.4+10.25+2-6])rotate([90,90,0])cylinder(r=3.7/2,h=200);
...
//translate([-110+59+5.3,-81.5+1.5+146,36-3.4])rotate([90,90,0])cylinder(r=3.7/2,h=200);
//#translate([-110+59+5.3+4.5-1,-81.5+1.5+146,36-3.4+10.25+2])rotate([90,90,0])#cylinder(r=3.7/2,h=200);
//#translate([-110+59+5.3+4.5-1-4.5-3,-81.5+1.5+146,36-3.4+10.25+5])rotate([90,90,0])cylinder(r=4.7/2,h=200);
//#translate([-110+59+5.3+4.5-1+4.5+6,-81.5+1.5+146,36-3.4+10.25+5])rotate([90,90,0])cylinder(r=4.7/2,h=200);
//translate([-110+59+5.3+9,-81.5+1.5+146,36-3.4])rotate([90,90,0])cylinder(r=3.7/2,h=200);
translate([-110+59,-81.5+1.5+46,16-8]){cylinder(r=3.7/2,h=12+1);translate([0,0,12])cylinder(r=8/2,h=3.5);}
translate([-110+59+20,-81.5+1.5+46,16-8]){cylinder(r=3.7/2,h=12+1);translate([0,0,12])cylinder(r=8/2,h=3.5);}
translate([-110+59+20,-81.5+1.5+46+20,16-8]){cylinder(r=3.7/2,h=12+1);translate([0,0,12])cylinder(r=8/2,h=3.5);}
...
union(){
translate([0,0,107.5])cylinder(r1=24/2,r2=9.5/2,h=5.5);
translate([0,0,107.5+5.5])cylinder(r=9.5/2,h=8.5);
cylinder(r=24/2,h=107.5);
translate([-28/2,-42.5/2,0])cube([28,42.5,2.5]);
}
translate([0,0,0])cylinder(r=15.5/2,h=82);
}
//need to finish here
translate([0,0,-71-21]){
cylinder(r=21/2,h=105);
cylinder(r=26/2,h=1.5);
}
}
