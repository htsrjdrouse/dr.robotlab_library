...
difference(){
union(){
translate([-5-5,-0.192-10-5,0])cube([109+10,43+10,5]);
///translate([3.2,-0.192,0])#cube([43,22,3]);
i=0;
translate([i*50-5,-6.5-8.7,0])cube([110,10,10]);
translate([i*50-5,-6.5-8.7+43,0])cube([110,10,10]);
for(i=[0:2]){
translate([i*50,-6.5,0])#cylinder(r=(2.8+2)/2,h=10);
translate([i*50,35-6.5,0])#cylinder(r=(2.8+2)/2,h=10);
}
}
...
difference(){
union(){
translate([-5,-0.192-10-1-2,0])cube([109,43+1+4,5]);
///translate([3.2,-0.192,0])#cube([43,22,3]);
}
//translate([-5,-0.192-10,-0.1])#cube([109/2,43-10,5]);
//translate([-5,-0.192-10-1,-0.1])#cube([109/2,43+10,6]);
...
translate([280,270-40,0])rotate([0,180,0])
amplifier_brd_holder();
//rotate([0,180,0])
...
//translate([0,-3,0])diaphragmpump_longwall();
...
//openmv nice assembly
//translate([-36,50,3.35])m12lens_screwshim(0.5);
//translate([64,-5,0])openmv_camera_base();
/*
translate([-100+65,59+30,17.85])lasermount_assy();
translate([-100,59,17.85])translate([0,20,39])rotate([-90,0,90])lasermount_connector();
*/
...
//URBESTÆInlet Module Plug Fuse Switch Male Power Socket 10A 250V 3 Pin IEC320 C14
...
//1
translate([150-10+5,-5+10,-30-0.1+6])rotate([90,0,0])cylinder(r=3/2,h=50);
translate([150-10+5,-5+10-8,-30-0.1+12])rotate([90,0,90])cylinder(r=3/2,h=50);
//2
translate([150-10+5,-5+10+71,-30-0.1+6])rotate([90,0,0])cylinder(r=3/2,h=50);
translate([150-10+5,-5+10-8+71,-30-0.1+12])rotate([90,0,90])cylinder(r=3/2,h=50);
//3
...
translate([-5,-5+10-8,-30-0.1+12])rotate([90,0,90])cylinder(r=3/2,h=50);
//6
translate([5,-5+10+71,-30-0.1+6])rotate([90,0,0])cylinder(r=3/2,h=50);
translate([-5,-5+10-8+71,-30-0.1+12])rotate([90,0,90])cylinder(r=3/2,h=50);
/*
...
translate([25,-12,-2])cylinder(r=4.7/2,h=20);
}
}
...
translate([-20,15-15,-5])cylinder(r=3.7/2,h=20);
translate([-20,15+15,-5])cylinder(r=3.7/2,h=20);
translate([74,15-15,-5])cylinder(r=3.7/2,h=20);
translate([74,15+15,-5])cylinder(r=3.7/2,h=20);
...
translate([180-10+20.4+10,240-16+10+10,-33])cylinder(r=3.5/2,h=200);
translate([180-10+20.4+10,240-16+10+20,-33])cylinder(r=3.5/2,h=200);


translate([-25+3,0,0]){
translate([175-10+5,210+10-10,-4])cylinder(r=3.7/2,h=20);
translate([175-10+5,210+10+12,-4])cylinder(r=3.7/2,h=20);
...
translate([-12,50,0])cylinder(r=3.5/2,h=200);
translate([-12+209,50,0])cylinder(r=3.5/2,h=200);
translate([-12,50+209,0])cylinder(r=3.5/2,h=200);
translate([-12+209,50+209,0])cylinder(r=3.5/2,h=200);
}
translate([-12,6,-4]){
//for(i=[0:3]){translate([50*i,0,0])cylinder(r=3.5/2,h=20);}
for(i=[1:5]){translate([50*i,210,0])cylinder(r=3.5/2,h=20);}
for(i=[0,1,2,4,5,6]){translate([50*i,120,0])cylinder(r=3.5/2,h=20);}
for(i=[1,2,3,4,5]){translate([50*i,0+20,0])cylinder(r=3.5/2,h=20);}
//for(i=[0:4]){translate([0,50*i,0])cylinder(r=3.5/2,h=20);}
for(i=[0:4]){translate([200+100-300+13,50*i,0])cylinder(r=3.5/2,h=20);}
for(i=[0:4]){translate([200+100,50*i,0])cylinder(r=3.5/2,h=20);}
}
}
}
}
...
translate([-50,400+sh,16])rotate([90,0,0])tslot20(484);
...
translate([10-39+450+3+45,102+102,0]){color("silver")cylinder(r=8.7/2,h=300);}
...
//RFTL1
translate([-50,460,16-25])rotate([90,0,0])tslot20(484);
}
...
translate([-54+503,169+75,90-20])rotate([0,0,180]){
motormount_smz();
}
...
translate([7.5,5,-6])cylinder(r=4.7/2,h=12);
translate([7.5,40-5,-6])cylinder(r=4.7/2,h=12);
...
module lm8uu_smz_glider(){
 ...
 translate([-19+35,40,42])difference(){
  ...
  translate([10-5,-25,12])rotate([0,90,0]){translate([0,0,0])cylinder(r=5.7/2,h=20);translate([-0,0,10])cylinder(r=10/2,h=5.2);}
  translate([10-5,-25,-12])rotate([0,90,0]){cylinder(r=5.7/2,h=10);translate([-0,0,10.0])cylinder(r=10/2,h=5.2);}
 }
}
...
module zbed_smz_components(shim,modshim){
 ...
 translate([0+30-60,0+3-4,shim-5+modshim+85-85])rotate([0,0,0])color("gainsboro")lm8uu_smz_glider();
...
translate([-8+6.5,0,0])color("lightgray")cube([397-13,350,3]);
...
/*
translate([14*25,130,0])cylinder(r=4.35/2,h=200);
translate([14*25,130+40,0])cylinder(r=4.35/2,h=200);
translate([5,10,-40]){
for(i=[0:14]){
translate([i*25,0,0])cylinder(r=4.35/2,h=200);
}
translate([15*25-5,0,0])cylinder(r=4.35/2,h=200);
}
translate([5,80,-40]){
for(i=[0:14]){
translate([i*25,0,0])cylinder(r=4.35/2,h=200);
...
for(i=[0]){
translate([i*25,-30,0])cylinder(r=4.35/2,h=200);
translate([i*25+25,60,0])cylinder(r=4.35/2,h=200);
}
translate([15*25-30,60,0])cylinder(r=4.35/2,h=200);
translate([15*25-5,0-50,0])cylinder(r=4.35/2,h=200);
translate([15*25-5,0,0])cylinder(r=4.35/2,h=200);
}
translate([5-15.9,80+193-56.5,-40]){
translate([15*25-5,0,0])cylinder(r=4.35/2,h=200);
translate([15*25-5-35,0,0])cylinder(r=4.35/2,h=200);
translate([15*25-5-125,0,0])cylinder(r=4.35/2,h=200);
}
*/
}
}
...
module zbed_smz(){
 ...
 translate([0,-340,293])rotate([180,0,0])zbed_smz_components(0,10);
 }
...
//length = 370.736
//width = 62.81
scale([0.58,0.58,1])difference(){
cube([639.2,108.3,3]);
translate([64,57.6,-0.1])cylinder(r=64.8/2,h=30);
translate([36,28.8,-0.1])cylinder(r=9.25/2,h=30);
translate([36,28.8,-0.1])cylinder(r=9.25/2,h=30);
translate([93.6,28.8,-0.1])cylinder(r=9.25/2,h=30);
translate([36,85.6,-0.1])cylinder(r=9.25/2,h=30);
translate([93.6,85.6,-0.1])cylinder(r=9.25/2,h=30);
...
translate([-20+60,19+10-15,-5])cylinder(r=3.7/2,h=200);
translate([74+60,19+10-15,-5])cylinder(r=3.7/2,h=200);
translate([-20+60,19+10+15,-5])cylinder(r=3.7/2,h=200);
translate([74+60,19+10+15,-5])cylinder(r=3.7/2,h=200);
}
}
...
difference(){
cube([542,84,5]);
translate([92.722,23.38,-0.1])cube([64.5,38.7,6]);
translate([123.7,68.53,-0.1])cylinder(r=4.7/2,h=30);
translate([123.7,15.92,-0.1])cylinder(r=4.7/2,h=30);
translate([448.12,5.12,-0.1])cube([19.68,19.66,20]);
}
}
*/
...
/*
mirror([0,1,0]){
translate([(20.16*0.508),(20.64*0.508),-0.1]){
 color("silver")cylinder(r=(11.22*0.508)/2,h=25);
 color("silver")translate([0,0,15])cylinder(r=(13)/2,h=5);
 color("black")translate([0,0,15])cylinder(r=(18)/2,h=5);
 color("silver")translate([0,0,15])cylinder(r=(17)/2,h=1);
 color("silver")translate([0,0,20])cylinder(r=(17)/2,h=1);
}
 
translate([(52.80*0.508),(62.24*0.508),-0.1]){
...
translate([22+168,400-385,-15-200])rotate([0,0,0])cylinder(r=5.7/2,h=500);
*/
}
