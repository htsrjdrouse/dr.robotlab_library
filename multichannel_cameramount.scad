...
for(i=[0,1,6,7]){
for(y=[-1:2]){
translate([-38.25+14-13.9+6.5+i*9,-70+30-10+8+5-16+1.5+y*9-3,22.5+8-8-2.5-4])rotate([-0,0,0])cylinder(r=3.8/2,h=12,$fn=35);
}
}
}
...
if (i==-1){
 ...
 translate([i*(9),0,0])
  pipette_p1000_noextrusion(8.1,0,"y");
}
else {
 translate([i*(9),0,0])pipette_p1000_noextrusion(8.1,0,"y");
}
/*
*/
