...
//translate([-38.25+14-13.9-14+2-0.5+2,-70+30-5-10-10+21-10,22.5])cube([26-1-4,20+10-21+10,20-4.2+0.3+0.45-4.5+15]);
...
translate([0,-28,0]){
translate([43-25-55-10,206.5-15-41.5+28+19+100,-60+430-28])rotate([-0,90,-90])tslot20(552);
}
